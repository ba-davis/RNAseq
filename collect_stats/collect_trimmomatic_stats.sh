...
paste -d "\t" tmp_sample_name tmp_input_read_pairs tmp_both_surviving tmp_both_surviving_percent tmp_forward_surviving tmp_forward_surviving_percent tmp_reverse_surviving tmp_reverse_surviving_percent tmp_drop tmp_drop_percent > summary_trimmomatic.txt

sed -i '1 i\SampleName\tInputReadPairs\tBothSurviving\tBothSurvivingPerc\tForwardSurviving\tForwardSurvivingPerc\tReverseSurviving\tReverseSurvivingPerc\tReadPairsDropped\tReadPairsDroppedPerc' summary_trimmomatic.txt
